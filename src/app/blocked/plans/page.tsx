...
export default function BlockedPlansPage() {
  ...
  const goToBilling = () => {
    ...
    // This assumes /app/dashboard/settings/billing exists later
    router.push("/pricing");
  };
  ...
  return (
    <div className="flex flex-col items-center text-center">
      ...
      <p className="text-muted-foreground mb-8">
        Your subscription for <span className="font-semibold text-foreground">{company?.name || "your company"}</span> has expired or requires a valid plan to continue accessing the workspace.
      </p>
